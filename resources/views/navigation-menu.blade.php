<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')">
                     ...
                     <x-jet-nav-link href="{{ route('charts2') }}" :active="request()->routeIs('charts2')">
                        {{ __('charts2') }}
                    </x-jet-nav-link>
                    ...
                    <x-jet-nav-link href="{{ route('material_sps') }}" :active="request()->routeIs('material_sps')">
                        {{ __('Sub Materials') }}
                    </x-jet-nav-link>
                    ...
                    <x-jet-nav-link href="{{ route('emps') }}" :active="request()->routeIs('emps')">
                        {{ __('Employees') }}
                    </x-jet-nav-link>
                </div>
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
           ...
           <x-jet-responsive-nav-link href="{{ route('charts2') }}" :active="request()->routeIs('charts2')">
                {{ __('Charts2') }}
            </x-jet-responsive-nav-link>
            ...
            <x-jet-responsive-nav-link href="{{ route('material_sps') }}" :active="request()->routeIs('material_sps')">
                {{ __('Sub Materials') }}
            </x-jet-responsive-nav-link>
            ...
            <x-jet-responsive-nav-link href="{{ route('emps') }}" :active="request()->routeIs('emps')">
                {{ __('Employees') }}
            </x-jet-responsive-nav-link>
